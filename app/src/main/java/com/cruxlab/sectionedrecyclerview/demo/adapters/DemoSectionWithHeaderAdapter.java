...
public class DemoSectionWithHeaderAdapter extends SectionWithHeaderAdapter<DemoItemViewHolder, DemoHeaderViewHolder> {

    private SectionManager sectionManager;
    public ArrayList<String> numbers = new ArrayList<>(Arrays.asList("One", "Two", "Three", "Four", "Five"));
    public int color;

    public DemoSectionWithHeaderAdapter(int color, SectionManager sectionManager, boolean isHeaderVisible, boolean isHeaderPinned) {
    ...
    public DemoHeaderViewHolder onCreateHeaderViewHolder(ViewGroup parent) {
        ...
        return new DemoHeaderViewHolder(view, color, this, sectionManager);
    }
